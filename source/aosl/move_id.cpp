...
namespace aosl
{
  ...
  {
    return new class Move_id (*this, f, c);
  }
...
{
  ::std::ostream&
  operator<< (::std::ostream& o, const Move_id& i)
  {
...
{
  void
  operator<< (::xercesc::DOMElement& e, const Move_id& i)
  {
    e << static_cast< const ::aosl::Unique_id& > (i);
  }

  void
  operator<< (::xercesc::DOMAttr& a, const Move_id& i)
  {
