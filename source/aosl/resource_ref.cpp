...
namespace aosl
{
  ...
  {
    return new class Resource_ref (*this, f, c);
  }
...
{
  ::std::ostream&
  operator<< (::std::ostream& o, const Resource_ref& i)
  {
...
{
  void
  operator<< (::xercesc::DOMElement& e, const Resource_ref& i)
  {
    e << static_cast< const ::aosl::Unique_ref& > (i);
  }

  void
  operator<< (::xercesc::DOMAttr& a, const Resource_ref& i)
  {
