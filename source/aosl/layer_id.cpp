...
namespace aosl
{
  ...
  {
    return new class Layer_id (*this, f, c);
  }
...
{
  ::std::ostream&
  operator<< (::std::ostream& o, const Layer_id& i)
  {
...
{
  void
  operator<< (::xercesc::DOMElement& e, const Layer_id& i)
  {
    e << static_cast< const ::aosl::Unique_id& > (i);
  }

  void
  operator<< (::xercesc::DOMAttr& a, const Layer_id& i)
  {
