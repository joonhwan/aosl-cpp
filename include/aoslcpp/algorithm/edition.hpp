...
namespace aoslcpp
{
	...
	/** Create an empty sequence with only one first stage, no moves, no objects and no resources. 
		...
		@param canvas_width		Width of the Canvas. It's the X axis.
		@param canvas_height	Height of the Canvas. It's the Y axis.
		@param canvas_height	Depth of the Canvas. It's the Z axis.
	...
	**/
	std::unique_ptr< aosl::Sequence > make_empty_sequence( const std::string& sequence_name
														, const double canvas_width, const double canvas_height, const double canvas_depth = 0.0
