...
/**
 * @file
 * @brief Generated from unit_stream.xsd.
 */

#ifndef AOSLCPP_AOSL__UNIT_STREAM_HPP
#define AOSLCPP_AOSL__UNIT_STREAM_HPP
...
{
  /**
   * @brief Union class corresponding to the %unit_stream
   * schema type.
   *
  ...
  class Unit_stream: public ::xml_schema::String
  {
     ...
     * @param v A string value.
     */
    Unit_stream (const ::std::string& v);
     ...
     */
    Unit_stream (const Unit_stream& x,
                 ::xml_schema::Flags f = 0,
                 ::xml_schema::Container* c = 0);
...
#endif // AOSLCPP_AOSL__UNIT_STREAM_HPP
