...
/**
 * @file
 * @brief Generated from unique_ref.xsd.
 */

#ifndef AOSLCPP_AOSL__UNIQUE_REF_HPP
#define AOSLCPP_AOSL__UNIQUE_REF_HPP
...
#include "aosl/unique_ref_forward.hpp"
...
{
  /**
   * @brief Class corresponding to the %unique_ref schema type.
   *
   * Type for reference to an unique Id.
   *
   * @nosubgrouping
   */
  class Unique_ref: public ::xml_schema::Idref
  {
     ...
     */
    Unique_ref (const ::xml_schema::Idref&);
...
#endif // AOSLCPP_AOSL__UNIQUE_REF_HPP
