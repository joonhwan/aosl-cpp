...
/**
 * @file
 * @brief Generated from object_video.xsd.
 */

#ifndef AOSLCPP_AOSL__OBJECT_VIDEO_HPP
#define AOSLCPP_AOSL__OBJECT_VIDEO_HPP
...
#include "aosl/object_video_forward.hpp"
...
{
  /**
   * @brief Class corresponding to the %object_video schema type.
   *
   * A Video is an audio and graphic Object that diplay a stream of both
   * images and sound.
   *
   * @nosubgrouping
   */
...
#endif // AOSLCPP_AOSL__OBJECT_VIDEO_HPP
