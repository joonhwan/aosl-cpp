...
/**
 * @file
 * @brief Generated from layer_id.xsd.
 */

#ifndef AOSLCPP_AOSL__LAYER_ID_HPP
#define AOSLCPP_AOSL__LAYER_ID_HPP
...
{
  /**
   * @brief Class corresponding to the %layer_id schema type.
   *
   * Layer Id type.
   *
   * @nosubgrouping
  ...
  class Layer_id: public ::aosl::Unique_id
  {
     ...
     * instance.
     */
    Layer_id (const ::xercesc::DOMElement& e,
     ...
     * instance.
     */
    Layer_id (const ::xercesc::DOMAttr& a,
              ::xml_schema::Flags f = 0,
              ::xml_schema::Container* c = 0);
...
#endif // AOSLCPP_AOSL__LAYER_ID_HPP
