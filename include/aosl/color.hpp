...
/**
 * @file
 * @brief Generated from color.xsd.
 */

#ifndef AOSLCPP_AOSL__COLOR_HPP
#define AOSLCPP_AOSL__COLOR_HPP
...
{
  /**
   * @brief Union class corresponding to the %color
   * schema type.
   *
