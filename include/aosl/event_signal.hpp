...
/**
 * @file
 * @brief Generated from event_signal.xsd.
 */

#ifndef AOSLCPP_AOSL__EVENT_SIGNAL_HPP
#define AOSLCPP_AOSL__EVENT_SIGNAL_HPP
...
#include "aosl/event_signal_forward.hpp"
...
{
  /**
   * @brief Class corresponding to the %event_signal schema type.
   *
   * A Signal is an Event is triggered by scripts or interpreter
   * implementation.
   * It's totally interpreter's implementation defined.
   * It should be used to manage interpreter-specific events and script
   * events.
   *
   * @nosubgrouping
   */
  class Event_signal: public ::aosl::Event
  {
    public:
    /**
     * @name source
     ...
     */
    typedef ::aosl::Signal_source SourceType;
  ...
  bool
  operator== (const Event_signal&, const Event_signal&);
...
{
  ::std::ostream&
  operator<< (::std::ostream&, const Event_signal&);
}
...
{
  void
  operator<< (::xercesc::DOMElement&, const Event_signal&);
}
...
#endif // AOSLCPP_AOSL__EVENT_SIGNAL_HPP
