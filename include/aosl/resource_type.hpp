...
/**
 * @file
 * @brief Generated from resource_type.xsd.
 */

#ifndef AOSLCPP_AOSL__RESOURCE_TYPE_HPP
#define AOSLCPP_AOSL__RESOURCE_TYPE_HPP
...
{
  /**
   * @brief Union class corresponding to the %resource_type
   * schema type.
   *
  ...
  class Resource_type: public ::xml_schema::String
  {
     ...
     * @param v A string value.
     */
    Resource_type (const ::std::string& v);
     ...
     * instance.
     */
    Resource_type (const ::xercesc::DOMAttr& a,
                   ::xml_schema::Flags f = 0,
                   ::xml_schema::Container* c = 0);
...
#endif // AOSLCPP_AOSL__RESOURCE_TYPE_HPP
