...
/**
 * @file
 * @brief Generated from library_include.xsd.
 */

#ifndef AOSLCPP_AOSL__LIBRARY_INCLUDE_HPP
#define AOSLCPP_AOSL__LIBRARY_INCLUDE_HPP
...
{
  /**
   * @brief Class corresponding to the %library_include schema type.
   *
   * Include an external librarie's resources.
   * Including another library means importing each of it's Resources
   * inside this library.
   *
   * @nosubgrouping
   */
  class Library_include: public ::aosl::Source_uri
  {
     ...
     */
    Library_include (const ::xml_schema::Uri&);
...
#endif // AOSLCPP_AOSL__LIBRARY_INCLUDE_HPP
