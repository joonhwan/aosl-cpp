...
/**
 * @file
 * @brief Generated from activation.xsd.
 */

#ifndef AOSLCPP_AOSL__ACTIVATION_HPP
#define AOSLCPP_AOSL__ACTIVATION_HPP
...
{
  /**
   * @brief Enumeration class corresponding to the %activation
   * schema type.
   *
  ...
  class Activation: public ::xml_schema::String
  {
    ...
    {
      /**
       * The object should reset to it's original state before activation.
       */
      reset,
      /**
       * The object should continue with it's current/last state on activation.
       */
      continue_
    };
...
#endif // AOSLCPP_AOSL__ACTIVATION_HPP
