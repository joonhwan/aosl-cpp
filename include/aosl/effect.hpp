...
/**
 * @file
 * @brief Generated from effect.xsd.
 */

#ifndef AOSLCPP_AOSL__EFFECT_HPP
#define AOSLCPP_AOSL__EFFECT_HPP
...
{
  /**
   * @brief Class corresponding to the %effect schema type.
   *
   * An Effect is a interpreter-specific special interpretation of one of
   * the Change types.
   * For example, a "fade" effect could be applied to activate, deactivate
   * or switch changes (and even on transform).
   ...
   * A future version might specify some standard effects that will be
   * expected to be implemented by all standard-compliant interpreters.
   *
   * @nosubgrouping
   */
...
#endif // AOSLCPP_AOSL__EFFECT_HPP
